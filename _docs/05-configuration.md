...
The default permalink style used by the theme is `permalink: /:categories/:title/`. If you have a post named `2016-01-01-my-post.md` with `categoryies: foo` in the YAML Front Matter, Jekyll will generate `_site/foo/my-post/index.html`.
...
{: .notice--info}
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTAyNDYyMzBdfQ==
-->