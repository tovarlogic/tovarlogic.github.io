...
**PoS:** Este método someramente significa que la validación de transacciones requieren un complejo y costoso cálculo criptográfico, que todos los mineros tratan de hacer simultáneamen. Luego el consumo eléctrico está directamente relacionado con el número de transacciones.
{: .notice--info}
# Enlaces de interés
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg0Mjk3MzExOSwtNDk3NDgzMTY1LDE0Mz
