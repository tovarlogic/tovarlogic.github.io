...
**PoS:** La diferencia con respecto a PoW radica en que se elije a quién debe hacer dicho cáculo en base a su nivel de participación en el sistema, por tanto, se excluye automáticamente al restométodo someramente significa que la validación de transacciones requieren un complejo y costoso cálculo criptográfico, que todos los mineros tratan de hacer simultáneamen. Luego el consumo eléctrico está directamente relacionado con el número de transacciones.
{: .notice--info}
# Enlaces de interés
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzOTUzNDQ1NzEsLTQ5NzQ4MzE2NSwxND
