...
2. **Apartar sistemáticamente todas las prenociones**. Se trata de la aplicación de la duda metódica de [Descartes](https://es.wikipedia.org/wiki/Ren%C3%A9_Descartes).
